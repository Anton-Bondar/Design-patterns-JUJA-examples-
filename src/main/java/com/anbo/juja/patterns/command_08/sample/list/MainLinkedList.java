...
import ua.com.juja.patterns.command.sample.list.command.linkedlist.Add;
import ua.com.juja.patterns.command.sample.list.command.linkedlist.Get;
import ua.com.juja.patterns.command.sample.list.command.linkedlist.IsEmpty;
import ua.com.juja.patterns.command.sample.list.command.linkedlist.Remove;
import ua.com.juja.patterns.command.sample.list.command.linkedlist.Size;
import ua.com.juja.patterns.command.sample.list.command.linkedlist.ToString;
