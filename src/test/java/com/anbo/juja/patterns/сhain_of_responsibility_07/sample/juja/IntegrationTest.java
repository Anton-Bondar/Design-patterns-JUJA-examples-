...
import ua.com.juja.patterns.chainOfResponsibility.sample.atm.AtmTest;
...
public class IntegrationTest {
    ...
    public void whenName_thenWeWillTry() {
        given("Стивен").when("А что это за фигня у вас?").then(
                "Q: А что это за фигня у вас?\n" +
                "A: Как вас зовут?\n" +
                "Стивен\n" +
                "A: Мы попробуем что-то сделать...\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: А что это за фигня у вас?\n" +
                "\t| Type: UNKNOWN\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenCanIBuy_thenGoToPayment() {
        given("Стивен").when("А можно купить шаблоны?").then(
                "Q: А можно купить шаблоны?\n" +
                "A: Как вас зовут?\n" +
                "Стивен\n" +
                "A: Да, вот линк на платежку http://juja.com.ua/...\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: А можно купить шаблоны?\n" +
                "\t| Type: LEAD\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenHaveAnIdea_thenWeWillCheck() {
        given("Стивен").when("У меня есть идея, по новому продукту - вот смотрите: ...").then(
                ...
                "C: Давай пробовать!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: У меня есть идея, по новому продукту - вот смотрите: ...\n" +
                "\t| Type: NEW_IDEA\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenErrorWithLms_thenFixIt() {
        given("Стивен").when("Там у вас ошибка с lms - вот смотрите: ...").then(
                ...
                "D: LMS исправил!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Там у вас ошибка с lms - вот смотрите: ...\n" +
                "\t| Type: BUG_REPORT\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenErrorWithSite_thenFixIt() {
        given("Стивен").when("Там у вас сайт упал, ошибка какая-то...").then(
                ...
                "D: Сайт поднял!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Там у вас сайт упал, ошибка какая-то...\n" +
                "\t| Type: BUG_REPORT\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenError_thenFixIt() {
        given("Стивен").when("Там ошибка. У вас глючит что-то, вот смотрите: ...").then(
                ...
                "D: Все пофикшено!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Там ошибка. У вас глючит что-то, вот смотрите: ...\n" +
                "\t| Type: BUG_REPORT\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenWantJujaAndPayAll_thenGoToTraining() {
        given("Стивен").when("Вот вам 150$ хочу juja core...").then(
                ...
                "C: Давай учиться!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Вот вам 150$ хочу juja core...\n" +
                "\t| Type: TRAINEE\n" +
                "\t| Amount: 150\n" +
                "\t| Debt: 0\n" +
                "\t+---------------------------------------\n");
    ...
    public void whenWantJujaAndPayNothing_thenGoodBuy() {
        given("Стивен", "0$").when("Хочу juja core, вот вам 1$").then(
                ...
                "A: Давай досвидания...\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Хочу juja core, вот вам 1$\n" +
                "\t| Type: SPAM\n" +
                "\t+---------------------------------------\n");
    }
    ...
    public void whenWantJujaAndPayPart_thenGoToTrainingWithDebt() {
        given("Стивен", "$50").when("Хочу juja core, вот вам 10$").then(
                ...
                "C: Давай учиться!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Хочу juja core, вот вам 10$\n" +
                "\t| Type: TRAINEE\n" +
                "\t| Amount: 50\n" +
                "\t| Debt: 100\n" +
                "\t+---------------------------------------\n");
    ...
    public void whenWantJujaAndPayAll_thenGoToTrainingWithoutDebt() {
        given("Стивен", "150$").when("Хочу juja core, вот вам 10$").then(
                "Q: Хочу juja core, вот вам 10$\n" +
                "A: Как вас зовут?\n" +
                "Стивен\n" +
                "A: Что-то пошло не так, повторите отправку. Минимальная сумма - 50$\n" +
    ...
    public void whenWantJujaAndPayPartAtStart_thenGoToTrainingWithDebt() {
        given("Стивен").when("Вот вам 50$ хочу juja core...").then(
                ...
                "C: Давай учиться!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Вот вам 50$ хочу juja core...\n" +
                "\t| Type: TRAINEE\n" +
                "\t| Amount: 50\n" +
                "\t| Debt: 100\n" +
                "\t+---------------------------------------\n");
    ...
    public void whenWantPatternAndPayAll_thenGoToTrainingWithoutDebt() {
        given("Стивен").when("Вот вам 50$ хочу design patterns...").then(
                ...
                "C: Давай учиться!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Вот вам 50$ хочу design patterns...\n" +
                "\t| Type: TRAINEE\n" +
                "\t| Amount: 50\n" +
                "\t| Debt: 0\n" +
                "\t+---------------------------------------\n");
    ...
    public void whenWantOtherProductAndPayMoney_thenWeWillTry() {
        given("Стивен").when("Вот вам 200$ хочу индивидуальную консультацию...").then(
                ...
                "C: Давай пробовать!\n" +
                "\t+---------------------------------------\n" +
                "\t| Стивен: Вот вам 200$ хочу индивидуальную консультацию...\n" +
                "\t| Type: NEW_IDEA\n" +
                "\t| Amount: 200\n" +
                "\t| Debt: 0\n" +
                "\t+---------------------------------------\n");
